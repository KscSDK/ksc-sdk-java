...
/**
 * <p>
 * Contains the output of AssociateBandWidthShare.
 * </p>
 */
@Data
public class AssociateBandWidthShareResult implements Serializable, Cloneable {
    ...
    public boolean equals(Object o) {
        ...
        AssociateBandWidthShareResult that = (AssociateBandWidthShareResult) o;
    ...
    @Override
    public AssociateBandWidthShareResult clone() {
        try {
