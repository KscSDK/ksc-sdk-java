...
/**
 * <p>
 * Contains the parameters for CreateSlbRule.
 * </p>
 */
@Data
public class CreateSlbRuleRequest extends KscWebServiceRequest implements
        Serializable, Cloneable, DryRunSupportedRequest<CreateSlbRuleRequest> {
    ...
    public boolean equals(Object o) {
        ...
        CreateSlbRuleRequest that = (CreateSlbRuleRequest) o;
        ...
        if (backendServerGroupId != null ? !backendServerGroupId.equals(that.backendServerGroupId) : that.backendServerGroupId != null)
            return false;
        if (hostHeaderId != null ? !hostHeaderId.equals(that.hostHeaderId) : that.hostHeaderId != null)
            return false;
    ...
    public Request<CreateSlbRuleRequest> getDryRunRequest() {
        Request<CreateSlbRuleRequest> request = new CreateSlbRuleRequestMarshaller()
                .marshall(this);
    ...
    @Override
    public CreateSlbRuleRequest clone() {
