...
/**
 * <p>
 * Contains the output of ModifyInstancesWithListener.
 * </p>
 */
@ToString
public class ModifyInstancesWithListenerResult implements Serializable, Cloneable {
    ...
    public boolean equals(Object o) {
        ...
        ModifyInstancesWithListenerResult that = (ModifyInstancesWithListenerResult) o;
    ...
    @Override
    public ModifyInstancesWithListenerResult clone() {
        try {
            return (ModifyInstancesWithListenerResult) super.clone();
