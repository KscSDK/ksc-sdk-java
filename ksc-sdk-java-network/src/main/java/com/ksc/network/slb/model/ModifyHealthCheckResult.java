 ...
 */
@ToString
public class ModifyHealthCheckResult implements Serializable, Cloneable {
    ...
    public boolean equals(Object o) {
        ...
        ModifyHealthCheckResult that = (ModifyHealthCheckResult) o;
    ...
    @Override
    public ModifyHealthCheckResult clone() {
        try {
            return (ModifyHealthCheckResult) super.clone();
