 ...
 */
@ToString
public class DeleteNatResult implements Serializable, Cloneable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DeleteNatResult other = (DeleteNatResult) obj;
		if (RequestId == null) {
    ...
    @Override
    public DeleteNatResult clone() {
        try {
            return (DeleteNatResult) super.clone();
