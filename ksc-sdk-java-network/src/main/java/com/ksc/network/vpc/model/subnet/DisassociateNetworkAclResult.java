...
public class DisassociateNetworkAclResult implements Serializable, Cloneable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DisassociateNetworkAclResult other = (DisassociateNetworkAclResult) obj;
		if (RequestId == null) {
    ...
    @Override
    public DisassociateNetworkAclResult clone() {
        try {
            return (DisassociateNetworkAclResult) super.clone();
