...
public class DisassociateRemoteCidrResult implements Serializable, Cloneable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DisassociateRemoteCidrResult other = (DisassociateRemoteCidrResult) obj;
		if (RequestId == null) {
    ...
    @Override
    public DisassociateRemoteCidrResult clone() {
        try {
            return (DisassociateRemoteCidrResult) super.clone();
