...
/**
 * <p>
 * Contains the parameters for CreateResourceRecord.
 * </p>
 */
@Data
public class CreateResourceRecordRequest extends KscWebServiceRequest implements
        Serializable, Cloneable, DryRunSupportedRequest<CreateResourceRecordRequest> {
    ...
    public boolean equals(Object o) {
        ...
        CreateResourceRecordRequest that = (CreateResourceRecordRequest) o;
    ...
    public Request<CreateResourceRecordRequest> getDryRunRequest() {
        Request<CreateResourceRecordRequest> request = new CreateResourceRecordRequestMarshaller()
                .marshall(this);
    ...
    @Override
    public CreateResourceRecordRequest clone() {
