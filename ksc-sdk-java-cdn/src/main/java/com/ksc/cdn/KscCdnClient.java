...
import com.ksc.cdn.model.content.transform.CreatePreloadRequestMarshaller;
import com.ksc.cdn.model.content.transform.CreatePreloadResultStaxUnmarshaller;
...
public class KscCdnClient extends KscWebServiceClient implements KscCdn{
	/** Provider for AWS credentials. */
	private AWSCredentialsProvider kscCredentialsProvider;

	/** Default signing name for the service. */
	private static final String DEFAULT_SIGNING_NAME = "cdn";

	/** The region metadata service name for computing region endpoints. */
	private static final String DEFAULT_ENDPOINT_PREFIX = "cn-shanghai-1";
	 ...
	 * @see DefaultAWSCredentialsProviderChain
	 */
	public KscCdnClient(ClientConfiguration clientConfiguration) {
	 ...
	 */
	public KscCdnClient(AWSCredentials awsCredentials) {
	 ...
	 */
	public KscCdnClient(AWSCredentials awsCredentials, ClientConfiguration clientConfiguration) {
	 ...
	 */
	public KscCdnClient(AWSCredentialsProvider awsCredentialsProvider) {
	 ...
	 *            connects to EPC (ex: proxy settings, retry counts, etc.).
	 */
	public KscCdnClient(AWSCredentialsProvider awsCredentialsProvider, ClientConfiguration clientConfiguration) {
	...
	public CreatePreloadResult createPreload(CreatePreloadRequest createPreloadRequest) {
        ...
        try {
            ...
            StaxResponseHandler<CreatePreloadResult> responseHandler = new StaxResponseHandler<CreatePreloadResult>(
					new CreatePreloadResultStaxUnmarshaller());
