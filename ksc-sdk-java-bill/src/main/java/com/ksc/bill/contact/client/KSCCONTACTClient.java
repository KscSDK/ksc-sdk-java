...
import com.ksc.bill.contact.model.transform.MailResultMarshaller;
import com.ksc.bill.contact.model.transform.MailResultUnmarshaller;
...
public class KSCCONTACTClient extends KscWebServiceClient implements KSCCONTACT{
    /**
     ...
     */
    public static final String DEFAULT_SIGNING_NAME = "contact";
     ...
     */
    public KSCCONTACTClient(AWSCredentials awsCredentials, String az) {
     ...
     */
    public KSCCONTACTClient(AWSCredentials awsCredentials, ClientConfiguration clientConfiguration, String az) {
     ...
     *                               connects to CONTACT (ex: proxy settings, retry counts, etc.).
     */
    public KSCCONTACTClient(AWSCredentialsProvider awsCredentialsProvider, ClientConfiguration clientConfiguration, String az) {
     ...
     */
    public KSCCONTACTClient(AWSCredentialsProvider awsCredentialsProvider, ClientConfiguration clientConfiguration, RequestMetricCollector requestMetricCollector, String az) {
    ...
    @Override
    public ContactResponse<MailResult> queryMailInList(MailRequest request) {
        return doAction(new MailResultMarshaller().marshall(request),new MailResultUnmarshaller()).getKscResponse();
    }
}
