 ...
 * @since 2021/7/22
 */
public class PayModeSummaryMarshaller implements Marshaller<Request<SummaryRequest>, SummaryRequest> {
    ...
    public Request<SummaryRequest> marshall(SummaryRequest req) {
        ...
        Request<SummaryRequest> request = new DefaultRequest<SummaryRequest>(
                req, "bill-union");
        request.addParameter("Action", "DescribeBillSummaryByPayMode");
