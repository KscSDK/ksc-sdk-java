...
public class HttpClientHelper {
	 ...
	 * @return 所代表远程资源的响应结果
	 */
	public static String sendPost(String url, String param, List<com.ksc.ket.util.Header> header2) {
		HttpPost post = null;
		String content = "";
		try {
			@SuppressWarnings("resource")
			...
			for (com.ksc.ket.util.Header header : header2) {
