...
public class QuotaDetail {
	...
	public String getQuotaTranDeadline() {
		return QuotaTranDeadline;
	}

	public void setQuotaTranDeadline(String quotaTranDeadline) {
	...
	public String getQuotaCopyDeadline() {
		return QuotaCopyDeadline;
	}

	public void setQuotaCopyDeadline(String quotaCopyDeadline) {
	...
	public String getQuotaPullDeadline() {
		return QuotaPullDeadline;
	}

	public void setQuotaPullDeadline(String quotaPullDeadline) {
