...
public class GetPresetDetailResultJsonUnmarshaller
		implements Unmarshaller<GetPresetDetailResult, JsonUnmarshallerContext> {
			...
			if (token == FIELD_NAME || token == START_OBJECT) {
				...
				if (context.testExpression("PresetDetail", targetDepth)) {
					...
					getPresetDetailResult
							.setPresetDetail(PresetDetailJsonUnmarshaller.getInstance().unmarshall(context));
	...
	private static GetPresetDetailResultJsonUnmarshaller instance;

	public static GetPresetDetailResultJsonUnmarshaller getInstance() {
		if (instance == null)
			instance = new GetPresetDetailResultJsonUnmarshaller();
		return instance;
	}
}
