 ...
 */
public class StartStreamRecordUnmarshaller implements Unmarshaller<StartStreamRecordResult,JsonUnmarshallerContext> {
    private static StartStreamRecordUnmarshaller instance;

    public static StartStreamRecordUnmarshaller getInstance() {
        if (instance == null)
            instance = new StartStreamRecordUnmarshaller();
        return instance;
    }

    @Override
    public StartStreamRecordResult unmarshall(JsonUnmarshallerContext context) throws Exception {
