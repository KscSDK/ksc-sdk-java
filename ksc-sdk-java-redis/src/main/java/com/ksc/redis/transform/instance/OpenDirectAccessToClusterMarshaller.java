...
/***
 * @ClassName: OpenDirectAccessToClusterMarshaller
 * @Description:TODO 缓存服务开启直连
 * @version : V1.0
 */
public class OpenDirectAccessToClusterMarshaller implements Marshaller<Request<DirectAccessToClusterRequest>, DirectAccessToClusterRequest> {
    ...
    public Request<DirectAccessToClusterRequest> marshall(DirectAccessToClusterRequest in) throws Exception {
        ...
        request.addParameter("Action", "OpenDirectAccessToCluster");
