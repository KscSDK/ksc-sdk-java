...
public abstract class KscRedisClient extends KscWebServiceClient {
    /**
     ...
     */
    public static final String DEFAULT_SIGNING_NAME = "kcs";
    ...
    /**
     * Constructs a new client to invoke service methods on REDIS. A credentials
     * provider chain will be used that searches for credentials in this order:
     * <ul>
     * <li>Environment Variables - AWS_ACCESS_KEY_ID and AWS_SECRET_KEY</li>
     * <li>Java System Properties - aws.accessKeyId and aws.secretKey</li>
     * <li>instance profile credentials delivered through the REDIS metadata
     * service</li>
     * </ul>
     * <p>
     * <p>
     ...
     */
    public KscRedisClient() {
        this(new DefaultAWSCredentialsProviderChain(), configFactory.getConfig(), null);
    }

    /**
     * Constructs a new client to invoke service methods on REDIS using the
     ...
     */
    public KscRedisClient(AWSCredentials awsCredentials, String az) {
     ...
     *                            connects to REDIS (ex: proxy settings, retry counts, etc.).
     */
    public KscRedisClient(AWSCredentials awsCredentials, ClientConfiguration clientConfiguration, String az) {
     ...
     *                               connects to REDIS (ex: proxy settings, retry counts, etc.).
     */
    public KscRedisClient(AWSCredentialsProvider awsCredentialsProvider, ClientConfiguration clientConfiguration, String az) {
     ...
     */
    public KscRedisClient(AWSCredentialsProvider awsCredentialsProvider, ClientConfiguration clientConfiguration, RequestMetricCollector requestMetricCollector, String az) {
    ...
    protected <X, Y extends KscWebServiceRequest> Response<X> doAction(Request<Y> request, Unmarshaller<X, JsonUnmarshallerContext> unmarshaller) {
        ...
        try {
            ...
            try {
                ...
                request.addParameter("Engine", "redis");
