...
public class GetMetricStatisticsBatchTest {
    ...
    private AWSCredentials credentials = new BasicAWSCredentials("AKLTD32j-_VLRPmoUpYrHBk8LQ",
            "OBkofwFHp/AzTLlGnL+mKhcO7mQBbNwpxezs7/c2mwcc2AMwhurbKleJ/CzMhpuVEg==");
