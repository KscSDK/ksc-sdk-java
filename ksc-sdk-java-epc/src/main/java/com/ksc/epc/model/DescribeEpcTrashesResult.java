...
/**
 * <p>
 * Contains the output of DescribeEpcTrashes.
 * </p>
 */
@Data
public class DescribeEpcTrashesResult implements Serializable, Cloneable {
    ...
    public boolean equals(Object o) {
        ...
        DescribeEpcTrashesResult that = (DescribeEpcTrashesResult) o;
    ...
    public DescribeEpcTrashesResult clone() {
        try {
            return (DescribeEpcTrashesResult) super.clone();
