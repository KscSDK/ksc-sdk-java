...
public class ResettableInputStream extends ReleasableInputStream {
    ...
    public void mark(int _) {
        ...
        try {
            ...
            throw new KscClientException("Failed to mark the file position", e);
        }
    ...
    public static ResettableInputStream newResettableInputStream(File file,
        ...
        try {
            ...
            throw errmsg == null
                ? new KscClientException(e)
                : new KscClientException(errmsg, e);
        }
    }
    ...
    public static ResettableInputStream newResettableInputStream(
        ...
        try {
            ...
            throw new KscClientException(errmsg, e);
        }
    }
}
