...
public enum ProgressEventType {
    //////////////////////////////////////////////////////////////////////////
    // Request Cycle Event:
    // related to the execution of a single http request-response to KSC
    //////////////////////////////////////////////////////////////////////////
    /**
    ...
    /**
     * Used to indicate the number of bytes to be sent to KSC.
     */
    REQUEST_BYTE_TRANSFER_EVENT,
    /**
     * Used to indicate the number of bytes received from KSC.
     */
    RESPONSE_BYTE_TRANSFER_EVENT,
    /**
     * Used to indicate the number of bytes discarded after being received from KSC.
     */
    ...
    /**
     * Event indicating that the client has started sending the KSC API request.
     ...
     * single http request-response to KSC; false otherwise.
     */
