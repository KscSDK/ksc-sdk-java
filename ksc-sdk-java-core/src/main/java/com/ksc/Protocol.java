...
/**
 * Represents the communication protocol to use when sending requests to KSC.
 * <p>
 * Communication over HTTPS is the default, and is more secure than HTTP, which
 * is why KSC recommends using HTTPS. HTTPS connections can use more system
...
public enum Protocol {
     ...
     * HTTP protocol, but may use slightly more system resources. KSC recommends
