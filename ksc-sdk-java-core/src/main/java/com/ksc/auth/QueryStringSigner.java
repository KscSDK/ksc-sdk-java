...
public class QueryStringSigner extends AbstractAWSSigner implements Signer {
    ...
    public void sign(SignableRequest<?> request, SignatureVersion version,
        ...
        if ( version.equals( SignatureVersion.V1 ) ) {
            ...
            throw new KscClientException("Invalid Signature Version specified");
        }
     ...
     */
    private String calculateStringToSignV2(SignableRequest<?> request) throws KscClientException {
