...
import com.ksc.auth.profile.internal.ProfilesConfigFileLoader;
import com.ksc.auth.profile.internal.securitytoken.ProfileCredentialsService;
import com.ksc.auth.profile.internal.securitytoken.STSProfileCredentialsServiceLoader;
...
public class ProfilesConfigFile {
     ...
     */
    public ProfilesConfigFile() throws KscClientException {
     ...
     * specified as a parameter to the constructor.
     */
    public ProfilesConfigFile(String filePath, ProfileCredentialsService credentialsService) throws KscClientException {
     ...
     */
    public ProfilesConfigFile(File file) throws KscClientException {
    ...
    private static File getCredentialProfilesFile() {
        ...
        if (userHome == null) {
            throw new KscClientException("Unable to load AWS profiles: "
