...
public class AWS3Signer extends AbstractAWSSigner {
     ...
     */
    @Override
    public void sign(SignableRequest<?> request, AWSCredentials credentials) throws KscClientException {
    ...
    protected boolean shouldUseHttpsScheme(SignableRequest<?> request) throws KscClientException {
        try {
            ...
            if (protocol.equals("http")) {
                ...
                throw new KscClientException("Unknown request endpoint protocol " +
                        "encountered while signing request: " + protocol);
            }
        } catch (MalformedURLException e) {
            throw new KscClientException("Unable to parse request endpoint during signing", e);
        }
    }
