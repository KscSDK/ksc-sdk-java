...
/**
 * Metadata for an KSC region, including its name and what services
 * are available in it.
 */
public class Region {
    ...
    /**
     * Returns the domain for this region; ex: &quot;ksyun.com&quot;.
     *
    ...
    /**
     * Returns the partition this region is in. I.E. 'ksc' or 'ksc-cn'
     *
     ...
     * @see ServiceAbbreviations
     */
    public <T extends KscWebServiceClient> T createClient(Class<T> serviceClass,
