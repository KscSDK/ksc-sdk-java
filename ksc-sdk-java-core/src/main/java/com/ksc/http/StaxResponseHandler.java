 ...
 */
// TODOFIX
public class StaxResponseHandler<T> implements HttpResponseHandler<KscWebServiceResponse<T>> {
    ...
    public KscWebServiceResponse<T> handle(HttpResponse response) throws Exception {
        ...
        try {
            KscWebServiceResponse<T> kscResponse = new KscWebServiceResponse<T>();
