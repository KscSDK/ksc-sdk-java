...
import com.ksc.metrics.ServiceLatencyProvider;
            ...
            try {
                if ("get".equals(method.getName())) {
                    ServiceLatencyProvider latencyProvider = new ServiceLatencyProvider(
                            KscServiceMetrics.HttpClientGetConnectionTime);
                    try {
                        return method.invoke(orig, args);
                    } finally {
                        KscSdkMetrics.getServiceMetricCollector()
