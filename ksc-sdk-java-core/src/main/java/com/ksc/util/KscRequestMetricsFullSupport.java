...
/**
 * In contrast to {@link KscRequestMetrics}, which is intended to be a minimal
 * support of KSC SDK request metrics, this class is the full support of KSC SDK
 * request metrics including features such as properties and sub-events.
 * <p>
 * This class is instantiated instead of {@link KscRequestMetrics} when request
 * metric collection is required during a particular service request/response
 * cycle.
 */
@NotThreadSafe
// TODOFIX
public class KscRequestMetricsFullSupport extends KscRequestMetrics {
    ...
    /* Latency Logger */
    private static final Log latencyLogger = LogFactory.getLog("com.ksc.latency");
    private static final Object KEY_VALUE_SEPARATOR = "=";
    private static final Object COMMA_SEPARATOR = ", ";

    /**
     * This constructor should be used in the case when KSC SDK metrics
     * collector is enabled.
     * 
     * @see KscRequestMetricsFullSupport
     */
    public KscRequestMetricsFullSupport() {
