...
/**
 * Utility class for accessing KSC SDK versioning information.
 */
@ThreadSafe
// TODOFIX
public class VersionInfoUtils {
    /** The KSC SDK version info file with SDK versioning info */
    static final String VERSION_INFO_FILE = "/com/ksc/sdk/versionInfo.properties";
    ...
    /**
     * Returns the current version for the KSC SDK in which this class is
     * running. Version information is obtained from from the
     * versionInfo.properties file which the KSC Java SDK build process
     * generates.
     *
     * @return The current version for the KSC SDK, if known, otherwise
    ...
    /**
     * Returns the current platform for the KSC SDK in which this class is
     * running. Version information is obtained from from the
     * versionInfo.properties file which the KSC Java SDK build process
     * generates.
     *
     * @return The current platform for the KSC SDK, if known, otherwise
	 ...
	 * the KSC services.  The User Agent encapsulates SDK, Java, OS and
	 * region information.
     */
   ...
   /**
     * Loads the versionInfo.properties file from the KSC Java SDK and
