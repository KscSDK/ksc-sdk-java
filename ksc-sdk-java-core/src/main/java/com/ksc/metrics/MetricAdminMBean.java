...
/**
 * MBean interface for KscSdkMetrics administration.
 */
public interface MetricAdminMBean {
    /**
     * Returns true if metrics at the KSC SDK level is enabled; false if
     * disabled.
     */
    public boolean isMetricsEnabled();

    /**
     * Returns the name of the request metric collector set at the KSC SDK
     * level, or NONE if there is none.
     */
    public String getRequestMetricCollector();

    /**
     * Returns the name of the service metric collector set at the KSC SDK
     * level, or NONE if there is none.
     */
    public String getServiceMetricCollector();

    /**
     * Starts the default KSC SDK metric collector, but only if no metric
     * collector is currently in use at the KSC SDK level.
     * 
     * @return true if the default KSC SDK metric collector has been
     *         successfully started by this call; false otherwise.
     */
    public boolean enableDefaultMetrics();

    /**
     * Disables the metric collector at the KSC SDK level.
     */
    ...
    /**
     * Returns the region configured for the default KSC SDK metric collector;
     * or null if the default is to be used.
     */
    public String getRegion();

    /**
     * Sets the region to be used for the default KSC SDK metric collector; or
     * null if the default is to be used.
     */
    public void setRegion(String region);

    /**
     * Returns the last set KSC credential file; or null if there is none.
     */
    public String getCredentialFile();

    /**
     * Sets the KSC credential file used by the default KSC SDK metric collector
     * for accessing CloudWatch.
     * 
     * @param filepath
     *            must be a valid path to an KSC credential property file.
     */
    public void setCredentialFile(String filepath)
        throws FileNotFoundException, IOException;

    /**
     * Returns the internal metric queue size to be used for the default KSC SDK
     * metric collector; or null if the default is to be used.
     */
    public Integer getMetricQueueSize();

    /**
     * Sets the metric queue size to be used for the default KSC SDK metric
     ...
     * the default KSC SDK metric collector; or null if the default is to be
    ...
    /**
     * Sets the queue poll time in millisecond to be used for the default KSC
