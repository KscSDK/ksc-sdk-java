 ...
 */
public class DummyResponseHandler implements HttpResponseHandler<KscWebServiceResponse<String>> {

    private boolean needsConnectionLeftOpen = false;

    @Override
    public KscWebServiceResponse<String> handle(HttpResponse response) throws Exception {
        return new KscWebServiceResponse<String>() {
        };
    }
