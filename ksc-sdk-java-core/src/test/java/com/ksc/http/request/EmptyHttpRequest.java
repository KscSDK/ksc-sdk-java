...
public class EmptyHttpRequest implements Request<Object> {
    ...
    private KscWebServiceRequest originalRequest = new KscWebServiceRequest() {
    };
    ...
    public void setOriginalRequest(KscWebServiceRequest originalRequest) {
    ...
    public ReadLimitInfo getReadLimitInfo() {
        return new KscWebServiceRequest() {
        };
    }
