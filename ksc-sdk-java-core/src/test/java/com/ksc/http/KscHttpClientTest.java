...
public class KscHttpClientTest {
    ...
    public void setUp() {
        ...
        client = new KSCHttpClient(config, httpClient, null);
    }
    ...
    public void testRetryIOExceptionFromHandler() throws Exception {
        ...
        HttpResponseHandler<KscWebServiceResponse<Object>> handler =
