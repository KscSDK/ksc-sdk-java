...
import com.ksc.handlers.StackedRequestHandler;
...
public class StackedRequestHandlerTest {
    ...
    public static class NoRequestHandlers {
        ...
        public void beforeMarshalling() {
            final KscWebServiceRequest inputRequest = mock(KscWebServiceRequest.class);
        ...
        public void afterError() {
            final Exception exception = new KscServiceException("Some service failure");
    ...
    public static class MultipleRequestHandlers {
         ...
         * modified {@link KscWebServiceRequest} returned by
         * {@link RequestHandler2#beforeMarshalling(KscWebServiceRequest)} and forward that
        ...
        public void beforeMarshalling_ModifiedRequestForwardedToNextInChain() {
            final KscWebServiceRequest origAwsRequest = mock(KscWebServiceRequest.class);
            final KscWebServiceRequest afterFirstAwsRequest = mock(KscWebServiceRequest.class);
            final KscWebServiceRequest afterSecondAwsRequest = mock(KscWebServiceRequest.class);
            final KscWebServiceRequest afterThirdAwsRequest = mock(KscWebServiceRequest.class);
