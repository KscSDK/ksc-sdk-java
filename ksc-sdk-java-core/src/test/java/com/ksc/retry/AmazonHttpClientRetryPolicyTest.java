...
/**
 * Tests that {@link KSCHttpClient#executeHelper()} method passes the correct
...
public class AmazonHttpClientRetryPolicyTest extends RetryPolicyTestBase {
    ...
    public void testServiceExceptionHandling() {
        ...
        KscServiceException expectedServiceException = null;
        try {
        ...
        Assert.assertEquals(
                ...
                context.getKscRequestMetrics()
                        .getTimingInfo().getCounter(KscRequestMetrics.Field.RequestCount.toString()).intValue());
    }
    ...
    public void testIOExceptioinHandling() {
        ...
        KscClientException expectedClientException = null;
        try {
            testedClient.execute(testedRepeatableRequest,
                                 null,
                                 errorResponseHandler,
