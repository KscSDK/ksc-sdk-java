...
public class KvsErrResultJsonUnmarshaller implements Unmarshaller<KvsErrResult, JsonUnmarshallerContext> {
	public KvsErrResult unmarshall(JsonUnmarshallerContext context) throws Exception {
