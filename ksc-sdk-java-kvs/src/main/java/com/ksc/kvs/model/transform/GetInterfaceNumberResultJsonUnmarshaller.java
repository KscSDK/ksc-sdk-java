...
import com.ksc.kvs.model.GetInterfaceNumberResult;
...
public class GetInterfaceNumberResultJsonUnmarshaller
	...
	private static GetInterfaceNumberResultJsonUnmarshaller instance;

	public static GetInterfaceNumberResultJsonUnmarshaller getInstance() {
		if (instance == null)
			instance = new GetInterfaceNumberResultJsonUnmarshaller();
		return instance;
	}
}
