...
public class GetTaskByTaskIDRequestMarshaller
		implements Marshaller<Request<GetTaskByTaskIDRequest>, GetTaskByTaskIDRequest> {
	...
	public Request<GetTaskByTaskIDRequest> marshall(GetTaskByTaskIDRequest getTaskByTaskIDRequest) {
		...
		Request<GetTaskByTaskIDRequest> request = new DefaultRequest<GetTaskByTaskIDRequest>(getTaskByTaskIDRequest,
				"kvs");
