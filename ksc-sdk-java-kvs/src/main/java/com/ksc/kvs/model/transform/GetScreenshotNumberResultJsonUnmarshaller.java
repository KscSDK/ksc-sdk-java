...
import com.ksc.kvs.model.GetScreenshotNumberResult;
import com.ksc.kvs.model.StatisticsDatas;
import com.ksc.transform.JsonUnmarshallerContext;
import com.ksc.transform.ListUnmarshaller;
import com.ksc.transform.Unmarshaller;

public class GetScreenshotNumberResultJsonUnmarshaller
		implements Unmarshaller<GetScreenshotNumberResult, JsonUnmarshallerContext> {

	public GetScreenshotNumberResult unmarshall(JsonUnmarshallerContext context) throws Exception {
		GetScreenshotNumberResult statisticsRequest = new GetScreenshotNumberResult();
	...
	private static GetScreenshotNumberResultJsonUnmarshaller instance;

	public static GetScreenshotNumberResultJsonUnmarshaller getInstance() {
		if (instance == null)
			instance = new GetScreenshotNumberResultJsonUnmarshaller();
		return instance;
	}
}
