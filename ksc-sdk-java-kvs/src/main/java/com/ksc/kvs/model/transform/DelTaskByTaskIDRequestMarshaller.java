...
public class DelTaskByTaskIDRequestMarshaller
		implements Marshaller<Request<DelTaskByTaskIDRequest>, DelTaskByTaskIDRequest> {
	...
	public Request<DelTaskByTaskIDRequest> marshall(DelTaskByTaskIDRequest taskRequest) {
		...
		Request<DelTaskByTaskIDRequest> request = new DefaultRequest<DelTaskByTaskIDRequest>(taskRequest, "kvs");
