...
public class StatisticsVCodecsJsonUnmarshaller implements Unmarshaller<StatisticsVCodecs, JsonUnmarshallerContext> {
		...
		while (true) {
			...
			if (token == FIELD_NAME || token == START_OBJECT) {
				...
				if (context.testExpression("Resolutions", targetDepth)) {
					context.nextToken();
					statisticsVCodecs.setResolutions(new ListUnmarshaller<StatisticsResolutions>(
							StatisticsResolutionsJsonUnmarshaller.getInstance()).unmarshall(context));
